        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Decree = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avg = table.Column<double>(type: "float", nullable: true),
                    Sum = table.Column<double>(type: "float", nullable: true),
                    CreatedTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ArticleID = table.Column<int>(type: "int", nullable: true),
                    DecreeID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
